...
mods.initialinventory.InvHandler.addStartingItem(<minecraft:stone_pickaxe>, 1);
mods.initialinventory.InvHandler.addStartingItem(<harvestcraft:gardensoupitem> * 16, 2);

mods.initialinventory.InvHandler.addStartingItem(<comforts:sleeping_bag:14>, 4);
